...
+(NSString *)currencyStringFromNumber:(NSNumber *)number {
    ...
    NSString *numberFormatado = [[Formatters currencyFormatter] stringFromNumber:number];
    
    numberFormatado = [numberFormatado stringByReplacingOccurrencesOfString:currencySymbol withString:[NSString stringWithFormat:@"%@ ", currencySymbol]];
    
    numberFormatado = [numberFormatado stringByReplacingOccurrencesOfString:@"(" withString:@""];
    numberFormatado = [numberFormatado stringByReplacingOccurrencesOfString:@")" withString:@""];
    numberFormatado = [numberFormatado stringByReplacingOccurrencesOfString:@"-" withString:@""];
    
//    DDLogInfo(@"numberFormatado: %@", numberFormatado);
    return numberFormatado;
